    ...
    CreateCommand.prototype.execute = function (name) {
        ...
        exec.on('exit', function (code) {
            if (code === 0) {
                ...
                console.log("\n");
                console.log("You can run " + chalk_1.default.cyanBright.bold('yarn watch') + " on the newly created project to actively watch and serve it on " + chalk_1.default.cyanBright.bold('localhost:8083'));
            }
            else {
